...
import (
	...
	gen "github.com/gartnera/connect-websockets/internal/gen"
	http "net/http"
	strings "strings"
)
...
type PingServiceClient interface {
	...
	Ping(context.Context, *connect_go.Request[gen.PingRequest]) (*connect_go.Response[gen.PingResponse], error)
	// Fail always fails.
	Fail(context.Context, *connect_go.Request[gen.FailRequest]) (*connect_go.Response[gen.FailResponse], error)
	// Sum calculates the sum of the numbers sent on the stream.
	Sum(context.Context) *connect_go.ClientStreamForClient[gen.SumRequest, gen.SumResponse]
	// CountUp returns a stream of the numbers up to the given request.
	CountUp(context.Context, *connect_go.Request[gen.CountUpRequest]) (*connect_go.ServerStreamForClient[gen.CountUpResponse], error)
	// CumSum determines the cumulative sum of all the numbers sent on the stream.
	CumSum(context.Context) *connect_go.BidiStreamForClient[gen.CumSumRequest, gen.CumSumResponse]
}
...
func NewPingServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) PingServiceClient {
	...
	return &pingServiceClient{
		ping: connect_go.NewClient[gen.PingRequest, gen.PingResponse](
			httpClient,
			baseURL+PingServicePingProcedure,
			opts...,
		),
		fail: connect_go.NewClient[gen.FailRequest, gen.FailResponse](
			httpClient,
			baseURL+PingServiceFailProcedure,
			opts...,
		),
		sum: connect_go.NewClient[gen.SumRequest, gen.SumResponse](
			httpClient,
			baseURL+PingServiceSumProcedure,
			opts...,
		),
		countUp: connect_go.NewClient[gen.CountUpRequest, gen.CountUpResponse](
			httpClient,
			baseURL+PingServiceCountUpProcedure,
			opts...,
		),
		cumSum: connect_go.NewClient[gen.CumSumRequest, gen.CumSumResponse](
			httpClient,
...
type pingServiceClient struct {
	ping    *connect_go.Client[gen.PingRequest, gen.PingResponse]
	fail    *connect_go.Client[gen.FailRequest, gen.FailResponse]
	sum     *connect_go.Client[gen.SumRequest, gen.SumResponse]
	countUp *connect_go.Client[gen.CountUpRequest, gen.CountUpResponse]
	cumSum  *connect_go.Client[gen.CumSumRequest, gen.CumSumResponse]
}

// Ping calls connect.ping.v1.PingService.Ping.
func (c *pingServiceClient) Ping(ctx context.Context, req *connect_go.Request[gen.PingRequest]) (*connect_go.Response[gen.PingResponse], error) {
	return c.ping.CallUnary(ctx, req)
}

// Fail calls connect.ping.v1.PingService.Fail.
func (c *pingServiceClient) Fail(ctx context.Context, req *connect_go.Request[gen.FailRequest]) (*connect_go.Response[gen.FailResponse], error) {
	return c.fail.CallUnary(ctx, req)
}

// Sum calls connect.ping.v1.PingService.Sum.
func (c *pingServiceClient) Sum(ctx context.Context) *connect_go.ClientStreamForClient[gen.SumRequest, gen.SumResponse] {
	return c.sum.CallClientStream(ctx)
}

// CountUp calls connect.ping.v1.PingService.CountUp.
func (c *pingServiceClient) CountUp(ctx context.Context, req *connect_go.Request[gen.CountUpRequest]) (*connect_go.ServerStreamForClient[gen.CountUpResponse], error) {
	return c.countUp.CallServerStream(ctx, req)
}

// CumSum calls connect.ping.v1.PingService.CumSum.
func (c *pingServiceClient) CumSum(ctx context.Context) *connect_go.BidiStreamForClient[gen.CumSumRequest, gen.CumSumResponse] {
...
type PingServiceHandler interface {
	...
	Fail(context.Context, *connect_go.Request[gen.FailRequest]) (*connect_go.Response[gen.FailResponse], error)
	// Sum calculates the sum of the numbers sent on the stream.
	Sum(context.Context, *connect_go.ClientStream[gen.SumRequest]) (*connect_go.Response[gen.SumResponse], error)
	// CountUp returns a stream of the numbers up to the given request.
	CountUp(context.Context, *connect_go.Request[gen.CountUpRequest], *connect_go.ServerStream[gen.CountUpResponse]) error
	// CumSum determines the cumulative sum of all the numbers sent on the stream.
	CumSum(context.Context, *connect_go.BidiStream[gen.CumSumRequest, gen.CumSumResponse]) error
}
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect_go.Request[gen.PingRequest]) (*connect_go.Response[gen.PingResponse], error) {
...
func (UnimplementedPingServiceHandler) Fail(context.Context, *connect_go.Request[gen.FailRequest]) (*connect_go.Response[gen.FailResponse], error) {
...
func (UnimplementedPingServiceHandler) Sum(context.Context, *connect_go.ClientStream[gen.SumRequest]) (*connect_go.Response[gen.SumResponse], error) {
...
func (UnimplementedPingServiceHandler) CountUp(context.Context, *connect_go.Request[gen.CountUpRequest], *connect_go.ServerStream[gen.CountUpResponse]) error {
...
func (UnimplementedPingServiceHandler) CumSum(context.Context, *connect_go.BidiStream[gen.CumSumRequest, gen.CumSumResponse]) error {
